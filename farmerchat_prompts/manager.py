...
class PromptManager:
    ...
    def _load_prompts(self):
        ...
        try:
            from .prompts.crop_advisory.claude import CLAUDE_PROMPTS as CROP_CLAUDE
            self._register_prompts(CROP_CLAUDE)
        except ImportError:
            pass
        ...
        try:
            from .prompts.prompt_evals.claude import CLAUDE_PROMPT_EVALS_PROMPTS
            if CLAUDE_PROMPT_EVALS_PROMPTS:  # Check if not empty
                self._register_prompts(CLAUDE_PROMPT_EVALS_PROMPTS)
        except ImportError:
            pass
